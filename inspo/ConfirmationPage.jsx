...
const ConfirmationPage = () => {
  ...
  const handleEdit = () => {
    navigate('/commander', { state: { orderData } });
  };
        ...
        <Col md={8} lg={7}>
          ...
          >
                    ...
                    <ListGroup variant="flush">
                      {cartItems.map(item => (
                        <ListGroup.Item key={item.id} className="d-flex align-items-center">
                          <img src={`http://localhost:5000/${item.image}`} alt={item.name} style={{ width: 40, height: 40, objectFit: 'cover', borderRadius: 8, marginRight: 12 }} />
                          <div>
            ...
            <div className="text-center mt-4">
              ...
              <Link to="/a-propos" className="text-decoration-none text-dark">Contactez-nous</Link>
            </div>
          </motion.div>
        </Col>
      </Row>
